...
import Exceptions.MenuExceptions2;
...
public class GameBoard implements Serializable{
  ...
  */
  private int calcNumMines() throws MenuExceptions2{
    //beginner
    if (gameLevel == 1){
    ...
    //expert
      ...
      throw new MenuExceptions2("ERROR: Unable to calculate number of mines");
    }
